...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/06/03 09:11:05 by joonpark          #+#    #+#             */
/*   Updated: 2021/06/03 13:51:13 by joonpark         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	print_without_hypen(t_format *format, long long int number, int n)
{
	int		t;
...
static void	print_width_larger(t_format *format, long long int number, int n)
{
	int		t;
...
static int	handle_zero_with_prec(t_format *format)
{
	long long int	t;
